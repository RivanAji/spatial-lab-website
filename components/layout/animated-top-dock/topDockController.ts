// Verbatim from ThreeUI (@designcodeio/threeui, MIT), AnimatedTopDock's
// spring/proximity controller. Fetched from the registered source manifest
// at https://threeui.com/source-code/animated-top-dock.json (revision
// 5a736cd3c1f6f19802f61ebb10e1701b9f7aa26e) and verified against its
// declared sha256 (506ab23d...) before being copied in — unmodified below
// this comment. Generic over content: it drives spring physics on any
// [data-dock-item] elements inside the ref'd <nav>, so our real nav links
// (components/layout/animated-top-dock/AnimatedTopDock.tsx) plug into it
